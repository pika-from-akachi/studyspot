/* ==========================================================================
   StudySpot — Inline SVG icon set (Lucide-style, MIT-licensed path data)
   Inline SVGs keep the app fully self-contained / offline-capable.
   ========================================================================== */
...
const ICONS = {
  ...
  'bookmark-filled': '<path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z" fill="currentColor" stroke="none"/>',
  ...
  'accessibility': '<circle cx="12" cy="12" r="10"/><circle cx="12" cy="7" r="1.5"/><path d="M12 10v5"/><path d="M8 11l4-1 4 1"/><path d="M12 15l-2 4"/>',
